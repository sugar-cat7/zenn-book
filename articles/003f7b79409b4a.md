...
それぞれのコンテナに対して適切なServiceAccountが割り当てられるようにGameServer側のトークン(`/var/run/secrets/kubernetes.io/serviceaccount`)を空のVolumeでオーバーライドしています。
